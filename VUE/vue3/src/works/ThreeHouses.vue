  ...
  <div class="game-detail-page">
    <div class="game-detail-container">
      <div class="game-header">
        ...
        <img src="@/assets/img/风花雪月/风花雪月封面图.jpg" alt="风花雪月" class="game-cover">
        <div class="game-info">
          <h1 class="game-title">《火焰纹章：风花雪月》</h1>
          <p class="game-subtitle">Fire Emblem: Three Houses</p>
          <div class="game-meta">
            <span class="meta-item">📱 机种：Nintendo Switch</span>
            <span class="meta-item">📅 发售日期：2019年7月26日</span>
            <span class="meta-item">💾 兵队系统</span>
          </div>
        </div>
      </div>
      <div class="game-intro">
        <h2>游戏简介</h2>
        <p>《火焰纹章：风花雪月》是系列时隔12年回归家用机的作品。故事背景设定于三国争霸的弗德兰大陆，副标题"风花雪月"体现岁月感。</p>
      </div>
      <div class="game-nav">
