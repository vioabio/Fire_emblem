  ...
  <div class="game-detail-page">
    <div class="game-detail-container">
      <div class="game-header">
        <img src="@/assets/img/圣魔之光石/圣魔之光石封面图.jpg" alt="圣魔之光石" class="game-cover">
        <div class="game-info">
          <h1 class="game-title">《火焰之纹章：圣魔之光石》</h1>
          <p class="game-subtitle">Fire Emblem: The Sacred Stones</p>
          <div class="game-meta">
            <span class="meta-item">📱 机种：GBA</span>
            <span class="meta-item">📅 发售日期：2004年4月23日</span>
            <span class="meta-item">💾 分支剧情系统</span>
          </div>
        </div>
      </div>
      <div class="game-intro">
        <h2>游戏简介</h2>
        <p>《圣魔之光石》以新大陆为舞台，主角兄妹伊弗列姆与艾瑞珂为复国而战。游戏拥有分支剧情与世界地图系统，角色塑造深刻。</p>
      </div>
      <div class="game-nav">
...
const tabs = [
  { path: 'map', name: '游戏地图', icon: '🗺️', component: defineAsyncComponent(() => import('./SacredStonesMap.vue')) },
  { path: 'characters', name: '登场人物', icon: '👥', component: defineAsyncComponent(() => import('./SacredStonesCharacters.vue')) },
  { path: 'guide', name: '游戏攻略', icon: '📖', component: defineAsyncComponent(() => import('./SacredStonesGuide.vue')) }
]
